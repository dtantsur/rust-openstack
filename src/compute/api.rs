...
/// List flavors.
pub fn list_flavors<Q: Serialize + Debug>(session: &Session, query: &Q) -> Result<Vec<IdAndName>> {
...
/// List key pairs.
pub fn list_keypairs<Q: Serialize + Debug>(session: &Session, query: &Q) -> Result<Vec<KeyPair>> {
...
/// List servers.
pub fn list_servers<Q: Serialize + Debug>(session: &Session, query: &Q) -> Result<Vec<IdAndName>> {
