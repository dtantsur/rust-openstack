...
pub trait V2API {
    ...
    fn get_image<S: AsRef<str>>(&self, id_or_name: S) -> Result<protocol::Image> {
        ...
        self.get_image_by_id(s)
            .if_not_found_then(|| self.get_image_by_name(s))
    }
    ...
    /// List images.
    fn list_images<Q: Serialize + Debug>(&self, query: &Q) -> Result<Vec<protocol::Image>>;
}
